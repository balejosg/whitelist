...
// Check server status
export async function checkRequestsServerStatus() {
...
window.approveRequest = async (id, btn) => {
    ...
    try {
        await RequestsAPI.approveRequest(id, groupId, Auth.getToken());
...
window.rejectRequest = async (id) => {
    ...
    try {
        await RequestsAPI.rejectRequest(id, reason, Auth.getToken());

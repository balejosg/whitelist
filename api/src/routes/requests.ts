 ...
 */
router.get('/groups/list', adminLimiter, requireAuth, filterByUserGroups, async (req: RequestWithUser, res: Response) => {
    try {
 ...
 */
router.get('/domains/blocked', adminLimiter, requireAuth, requireAdmin, async (_req: Request, res: Response) => {
    try {
 ...
 */
router.post('/domains/check', adminLimiter, requireAuth, async (req: Request<object, unknown, CheckDomainBody>, res: Response) => {
...
router.get('/', adminLimiter, requireAuth, filterByUserGroups, (req: RequestWithUser, res: Response) => {
    ...
    try {
        let requests = storage.getAllRequests((status as import('../types/index.js').RequestStatus) ?? null);
 ...
 */
router.post('/:id/approve', adminLimiter, requireAuth, canApproveRequest, async (req: RequestWithUser, res: Response) => {

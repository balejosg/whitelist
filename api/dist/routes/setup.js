 ...
 */
router.get('/status', setupLimiter, (_req, res) => {
    try {
 ...
 * Public endpoint (no authentication required)
 */
router.post('/first-admin', firstAdminLimiter, async (req, res) => {
    try {
 ...
 */
router.get('/registration-token', requireAuth, requireAdmin, (_req, res) => {
    try {
 ...
 * Requires admin authentication
 */
router.post('/regenerate-token', requireAuth, requireAdmin, (req, res) => {
    try {
 ...
 */
router.post('/validate-token', setupLimiter, (req, res) => {
    try {

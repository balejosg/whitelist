 ...
 * GET /api/users
 */
router.get('/', adminLimiter, requireAuth, requireAdmin, (_req, res) => {
    try {
 ...
 */
router.get('/roles/teachers', adminLimiter, requireAuth, requireAdmin, (_req, res) => {
    try {
 ...
 * POST /api/users
 */
router.post('/', adminLimiter, requireAuth, requireAdmin, (req, res, next) => {
    void (async () => {
 ...
 * PATCH /api/users/:id
 */
router.patch('/:id', adminLimiter, requireAuth, requireAdmin, (req, res, next) => {
    void (async () => {
 ...
 */
router.post('/:id/roles', adminLimiter, requireAuth, requireAdmin, (req, res, next) => {
    void (async () => {
